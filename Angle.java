 ...
 * minute).
 * <ul>
 * <li>Valid angles for latitude range from 0 to 90 deg N or S, inclusive. Note
 * that 0 deg N & S are different representations of the same latitude
 * (equator).
 * <li>Valid angles for longitude range from 0 to 180 deg E or W, inclusive. 0
 * deg E & W are different representations of the same longitude (prime
 * meridian), and 180 deg E & W are also different representations of the same
 * longitude (antimeridian).
 * <li>Valid angles for displacement range from 0 to 180 deg, inclusive.
 * </ul>
 * 
 * <p>
...
public class Angle {
    ...
    /*
     * Rep invariant: 0 <= degrees 0 <= minutes, seconds < 60 direction != null
     */
     ...
     * 
     * @param degrees
     *            degrees of arc, must be nonnegative
     * @param minutes
     *            minutes of arc, must be nonnegative
     * @param seconds
     *            seconds of arc, must be nonnegative
     * @param direction
     *            cardinal direction
     */
    ...
    /**
     * @return positive whole degrees of arc in this angle
     */
    public int degrees() {
        return degrees;
    }
    ...
    /**
     * @return positive whole arc minutes in this angle, after whole degrees
     */
    public int minutes() {
        return minutes;
    }
    ...
    /**
     * @return positive arc seconds in this angle, after whole arc minutes
     */
    public int seconds() {
        return seconds;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.direction().equals(that.direction()) && this.degrees() == that.degrees()
                && this.minutes() == that.minutes() && this.seconds() == that.seconds();
    }
