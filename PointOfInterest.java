...
public class PointOfInterest {
    ...
    /*
     * Rep invariant: latitude & longitude are valid for measuring latitude &
     * longitude, respectively name is not empty latitude, longitude, name,
     * description != null
     */
     ...
     * 
     * @param latitude
     *            latitude of the POI, must be a valid latitude as defined in
     *            {@link Angle}
     * @param longitude
     *            longitude of the POI, must be a valid longitude as defined in
     *            {@link Angle}
     * @param name
     *            name of the POI, must be nonempty
     * @param description
    ...
    public boolean equals(Object obj) {
        ...
        return this.latitude().equals(that.latitude()) && this.longitude().equals(that.longitude())
                && this.name().equals(that.name()) && this.description().equals(that.description());
    }
